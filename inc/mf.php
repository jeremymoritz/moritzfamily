...
$nav_links = [
  ...
  (object) [
    'display' => '<span class="d-md-none d-lg-inline">Kids </span>Quotes',
    'href' => 'quotes.php',
    'title' => 'Quotes from the Kids'
  ],
  (object) [
    'display' => '<span class="d-md-none d-lg-inline">Our </span>Videos',
    'href' => 'videos.php',
    'title' => 'Moritz Family Videos'
  ],
  (object) [
    'display' => '<span class="d-md-none d-lg-inline">Mission </span>Statement',
    'href' => 'mission.php',
  ...
  (object) [
    'display' => '<span class="d-md-none d-lg-inline">Our </span>Work',
    'href' => 'work.php',
    'title' => 'Rhythm City, Web Design, Piano Lessons, etc.'
  ],
  (object) [
    'display' => 'Fun<span class="d-md-none d-lg-inline"> Stuff</span>',
    'href' => 'fun.php',
    'title' => 'Little Miss Terrific... Kitten Catastrophe... ya know, fun stuff. :-)'
  ]
];

$nav_links_html = ['navbar' => '', 'list-group' => ''];

foreach ($nav_links as $nav_link) {
  $nav_links_html['navbar'] .= '
    <li class="nav-item">
      <a
        class="nav-link"
        href="' . $nav_link->href . '"
  ...
  $nav_links_html['list-group'] .= '
    <a
      ...
      href="' . $nav_link->href . '"
      title="' . $nav_link->title . '"
    >' . trim(strip_tags($nav_link->display)) . '</a>';
}
