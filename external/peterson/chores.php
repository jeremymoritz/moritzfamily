...
<head>
	...
	<link rel="apple-touch-icon" sizes="57x57" href="/img/apple-touch-icons/clean-57.png">
	<link rel="apple-touch-icon" sizes="72x72" href="/img/apple-touch-icons/clean-72.png">
	<link rel="apple-touch-icon" sizes="114x114" href="/img/apple-touch-icons/clean-114.png">
	<link rel="apple-touch-icon" sizes="144x144" href="/img/apple-touch-icons/clean-144.png">
...
<body>
	...
	<script>
		...
		$(function documentReady() {
			$.getJSON('./chores.json').then(function assignChoresToLocalArray(choresJson) {
